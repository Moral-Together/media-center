        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-12 text-slate-600">
          <div className="flex items-center gap-4">
            ...
            <div className="text-start">
              <p className="text-xs text-slate-400 uppercase tracking-widest font-bold">דוא״ל</p>
              <a href="mailto:hello@nexgen.dev" className="hover:text-slate-900 transition-colors">
                hello@nexgen.dev
              </a>
            </div>
          </div>
          <div className="flex items-center gap-4">
            ...
            <div className="text-start">
              <p className="text-xs text-slate-400 uppercase tracking-widest font-bold">טלפון</p>
              <a href="tel:+972500000000" className="hover:text-slate-900 transition-colors">
                050 000 0000
              </a>
            </div>
          </div>
