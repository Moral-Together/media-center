      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
        ...
        <motion.div
           {...(skipRouteEnter
             ...
             : { variants: containerStagger, initial: 'hidden' as const, animate: 'show' as const })}
        ...
        >
           {stats.map((stat, idx) => (
             <motion.div
               ...
               className="bg-white border border-slate-100 shadow-sm rounded-2xl p-6 flex flex-col items-center justify-center text-center hover:shadow-md hover:border-slate-200 transition-all"
             >
        ...
        {[
          ...
          { icon: Award, title: 'הערכים שלנו', desc: 'שקיפות מלאה, חדשנות ללא מעצורים, ומחויבות טוטאלית להצלחת הפרויקטים של הלקוחות שלנו.', color: '#7c3aed' },
           ...
           <motion.div
            ...
            transition={skipRouteEnter ? undefined : { delay: i * 0.08 }}
            whileHover={cardHover}
