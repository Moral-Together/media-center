...
import { cardHover, scrollRevealMotion } from '../lib/motion';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
        ...
        <div className="grid grid-cols-2 gap-4">
          {stats.map((stat, idx) => (
            <div
              key={idx}
              className="bg-white border border-slate-100 shadow-sm rounded-2xl p-6 flex flex-col items-center justify-center text-center hover:shadow-md hover:border-slate-200 transition-shadow"
            >
